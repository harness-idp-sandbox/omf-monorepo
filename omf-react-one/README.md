...
- **Repository path:** `/omf-react-one`
- **Open PRs (search):** https://github.com/harness-idp-sandbox/omf-react-one/pulls?q=is%3Apr+omf-react-one
...
|---|---|---|
| Dev | https://omf-react-one.dev.example.com | _(replace with your real dev domain)_ |
| Staging | https://omf-react-one.stg.example.com |  |
| Prod | https://omf-react-one.example.com |  |

> If you don’t have ingress yet, you can still access a running pod locally:
>
> ```bash
> # Example: adjust namespace/service as needed
> kubectl port-forward -n <namespace> svc/omf-react-one-web 5173:80
...
- **Branching:** feature branches like `feature/omf-react-one-<run-number>`
